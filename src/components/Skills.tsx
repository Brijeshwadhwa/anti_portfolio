...
import { Shield, Radar, Code, Terminal, CheckCircle2 } from "lucide-react";
...
export const Skills: React.FC = () => {
  ...
  const iconMap: Record<string, React.ReactNode> = {
    ...
    Code: <Code className="w-5 h-5 text-warm-blue" />,
    Terminal: <Terminal className="w-5 h-5 text-warm-accent" />
  };

  return (
    <section id="skills" className="py-16 relative z-10 bg-warm-bg">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4 pb-3 border-b border-warm-border">
                  <div className="p-2.5 rounded-xl bg-warm-bgSecondary border border-warm-border">
                    {iconMap[group.iconName] || <Code className="w-5 h-5 text-warm-accent" />}
                  </div>
